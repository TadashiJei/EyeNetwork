...
INSERT INTO `core_notifications` (`id`, `name`, `subject`, `message`, `info`) VALUES (NULL, 'EyeNet Incident Unresolved', '{subject}', '<p>Hello {contact},</p><p><b>{message}</b></p><p><br>Best regards,<br>{company}<br></p>', '');
